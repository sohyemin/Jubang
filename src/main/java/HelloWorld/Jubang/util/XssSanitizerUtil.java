...
import static HelloWorld.Jubang.exception.ErrorCode.XSS_INPUT_ERROR;
...
//            System.out.println("Could not strip XSS from value = " + value + " | ex = " + ex.getMessage());
            ...
            throw new CustomException(XSS_INPUT_ERROR, "Could not strip XSS from value = " + value + " | ex = " + ex.getMessage());
        }
